...
// 绘制平滑点的曲线
            ...
            for (int i = 0; i < length - 1; ++i) {
                ...
                g2D.drawLine(xDelta * (MAX_COUNT_OF_VALUES - length + i), (Integer) values.get(i),

                        xDelta * (MAX_COUNT_OF_VALUES - length + i + 1), (Integer)values.get(i + 1));
